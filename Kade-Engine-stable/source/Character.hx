	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'spirit':
				...
				case 'onerepublic':
				// ONEREPUBLIC ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('OneRepublic', 'shared', true);
				frames = tex;
				animation.addByPrefix('idle', 'OneRepublic idle', 24, false);
				animation.addByPrefix('singUP', 'OneRepublic idle', 24, false);
				animation.addByPrefix('singRIGHT', 'OneRepublic idle', 24, false);
				animation.addByPrefix('singDOWN', 'OneRepublic idle', 24, false);
				animation.addByPrefix('singLEFT', 'OneRepublic idle', 24, false);
				animation.addByIndices('idleLoop', "OneRepublic idle", [11, 12], "", 12, true);
